      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        <Card className="w-full max-w-md p-8 bg-card">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground text-pretty">Sign in to your account to continue</p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              <input id="remember" type="checkbox" className="size-4 rounded border-input accent-accent" />
